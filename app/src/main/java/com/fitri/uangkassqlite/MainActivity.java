...
public class MainActivity extends AppCompatActivity {
    ...
    private void KasAdapter()
    {
        ...
        if (i == 0)
        {
            Toast.makeText(getApplicationContext(), "Tidak Ada Transaksi Untuk Ditampilkan", Toast.LENGTH_SHORT).show();
        }
    ...
    private void Hapus()
    {
        ...
        builder.setPositiveButton("Iya", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(getApplicationContext(), "Transaksi Berhasil Di Hapus", Toast.LENGTH_SHORT).show();
                KasAdapter();
            }
        });
